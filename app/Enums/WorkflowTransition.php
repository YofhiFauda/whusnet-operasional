...
enum WorkflowTransition: string
{
    ...
    public function allowedNextTransitions(): array
    {
        return match($this) {
            ...
            self::WAITING_ACC => [self::WAITING_INSTALLATION, self::REJECTED],
            ...
            self::VERIFICATION_ADMIN => [self::ACTIVE, self::WAITING_INSTALLATION, self::REVISION_INSTALLATION, self::REJECTED],
