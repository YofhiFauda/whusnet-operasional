# AGENT_EXECUTION_GUIDE.md — Sprint 9–13: Advanced RBAC (Feature–Action–Scope)

**Untuk:** AI Agent (Antigravity) yang mengerjakan Sprint 9–13
...
1. **Jangan mulai Sprint 9 sebelum `S8-T006 — Import Data Legacy sand_db_sandya.sql` berstatus `Done`.** Cek di `docs/TASKS.md`. Jika belum Done, STOP dan laporkan ke user — jangan lanjut.
2. **Hanya boleh ada SATU task berstatus `in_progress` dalam satu waktu**, di seluruh Sprint 9–13. Jika menemukan lebih dari satu, STOP dan laporkan konflik ke user.
3. **Kerjakan task sesuai urutan ID** (S9-T001 → S9-T002 → ... → S13-T014). Jangan loncat task kecuali task tersebut eksplisit ditandai independen di bagian "Dependency" masing-masing.
...
9. **Definition of Done (DoD) di §8 berlaku untuk SEMUA task** Sprint 9–13, tambahan dari DoD spesifik per task.
...
### 1.2 Daftar Role (FIXED — jangan tambah/kurang tanpa instruksi eksplisit user)
...
Tabel ini WAJIB dipakai sebagai isi awal seeder `role_permissions` di Sprint 10. Jangan bikin permission baru di luar tabel ini kecuali fitur baru yang memang belum ada.
...
Jika saat Sprint 10/11 agent menemukan Controller/route lain yang belum punya permission code, TAMBAHKAN ke tabel ini (edit dokumen ini), JANGAN langsung hardcode role di Controller tsb sebagai jalan pintas.
...
### S9-T001 — Normalisasi docs/TASKS.md
**Status:** todo
**Dependency:** S8-T006 (Done)
**Tujuan:** Merapikan `docs/TASKS.md`: hapus duplikasi, masukkan roadmap Sprint 9–13.
**Checklist:** lihat checklist asli di `Qwen_markdown` S9-T001.
**Definition of Done:** Tidak ada task/sprint duplikat; hanya satu task `In Progress`; Sprint 9+ semua `Todo`.

### S9-T002 — Update docs/RBAC_MATRIX.md
**Status:** todo
**Dependency:** S9-T001 (done)
**Tujuan:** Dokumentasikan role, Feature Tree, Action Permission, User Scope sesuai §1 dokumen ini.
**Checklist:** lihat checklist asli S9-T002, **plus**: sertakan tabel pemetaan dari §2 dokumen ini ke dalam `RBAC_MATRIX.md`.
**Definition of Done:** Semua 9 role terdokumentasi dengan permission default sesuai §2; tidak ada rekomendasi role per cabang.

### S9-T003 — Update docs/DATABASE_RULES.md
**Status:** todo
**Dependency:** S9-T002 (done)
...
**Checklist:** lihat checklist asli S9-T003.
...
### S9-T004 — Update docs/BUSINESS_RULES.md
**Status:** todo
**Dependency:** S9-T003 (done)
...
### S9-T005 — Update docs/PAGE_STRUCTURE.md
**Status:** todo
**Dependency:** S9-T004 (done)
...
### S9-T006 — Update docs/DEFINITION_OF_DONE.md
**Status:** todo
**Dependency:** S9-T005 (done)
...
### S9-T007 — Update docs/MVP_SUCCESS_CHECKLIST.md
**Status:** todo
**Dependency:** S9-T006 (done)
**Definition of Done:** Checklist final mencakup seluruh item Advanced RBAC.

**Gate keluar Sprint 9:** Semua S9-T001 s/d S9-T007 berstatus `done` sebelum agent boleh mulai S10-T001.
...
**Dependency Sprint:** Seluruh Sprint 9 `done`.

### S10-T001 — Migration: tabel `features`
**Status:** todo
**Dependency:** S9-T003 (done)
**Checklist:**
...
### S10-T002 — Migration: tabel `actions`
**Status:** todo
**Dependency:** S10-T001 (done)
**Checklist:**
...
### S10-T003 — Migration: tabel `permissions`
**Status:** todo
**Dependency:** S10-T002 (done)
**Checklist:**
...
### S10-T004 — Migration: tabel `roles` + `role_permissions`
**Status:** todo
**Dependency:** S10-T003 (done)
**Checklist:**
...
### S10-T005 — Migration: tabel `user_role_scopes` + `user_role_scope_targets`
**Status:** todo
**Dependency:** S10-T004 (done)
**Checklist:**
...
### S10-T006 — Migration: tabel `user_permission_overrides` (optional)
**Status:** todo
**Dependency:** S10-T005 (done)
**Definition of Done:** Tabel tersedia, belum wajib dipakai di Sprint 10, siap dipakai Sprint 11 jika diperlukan.

### S10-T007 — Seeder permission awal sesuai pemetaan §2
**Status:** todo
**Dependency:** S10-T003 (done)
**Checklist:**
...
### S10-T008 — `app/Services/RbacService.php` (core engine)
**Status:** todo
**Dependency:** S10-T007 (done)
**Checklist:**
...
### S10-T009 — Helper Scope resolver (`app/Services/PopScopeResolver.php`)
**Status:** todo
**Dependency:** S10-T005 (done)
**Checklist:**
...
**Gate keluar Sprint 10:** S10-T001 s/d S10-T009 `done`. Tidak ada UI dibuat di sprint ini.

---

## 6. SPRINT 11 — UI, Middleware, Scope Enforcement, Tests

**Dependency Sprint:** Seluruh Sprint 10 `done`.

### S11-T001 — Middleware `CheckFeaturePermission`
**Status:** todo
**Dependency:** S10-T008 (done)
**Checklist:**
...
### S11-T002 — Pasang middleware ke seluruh route dari §2
**Status:** todo
...
### S11-T003 — Eloquent Global Scope `PopScope`
**Status:** todo
**Dependency:** S10-T009 (done)
**Checklist:**
...
### S11-T004 — Halaman Feature Management
**Status:** todo
**Dependency:** S11-T001 (done), S9-T005 (done)
...
### S11-T005 — Halaman Action Management
**Status:** todo
...
### S11-T006 — Halaman Permission Matrix
**Status:** todo
...
### S11-T007 — Halaman Role Permission Matrix
**Status:** todo
...
### S11-T008 — Halaman User Role Scope
**Status:** todo
**Dependency:** S11-T007 (done), S10-T005 (done)
**Checklist:**
...
### S11-T009 — Preview Effective Permission
**Status:** todo
**Dependency:** S10-T008 (done), S11-T008 (done)
...
### S11-T010 — Sidebar/menu berbasis permission
**Status:** todo
**Dependency:** S11-T002 (done)
**Checklist:**
- [ ] Menu hanya tampil jika user punya minimal 1 permission `view` di feature terkait
- [ ] **WAJIB diingat:** menyembunyikan menu BUKAN pengganti middleware route. Middleware di S11-T002 tetap berlaku meski menu disembunyikan.
**Definition of Done:** Akses langsung via URL tetap diblok middleware meski menu tidak terlihat di sidebar.

### S11-T011 — Field-level permission untuk data sensitif
**Status:** todo
...
### S11-T012 — Test suite Advanced RBAC
**Status:** todo
**Dependency:** S11-T001 s/d S11-T011 (semua done)
...
**Gate keluar Sprint 11:** Semua S11-T001 s/d S11-T012 `done`.
...
### S12-T001 — Audit seluruh route terhadap §2 dan dokumen RBAC_MATRIX.md
**Status:** todo
**Dependency:** S11-T012 (done)
**Checklist:**
...
### S12-T002 — Audit log untuk seluruh perubahan RBAC
**Status:** todo
...
### S12-T003 — Penetration-style test: akses lintas-scope
**Status:** todo
**Dependency:** S12-T001 (done)
**Checklist:**
...
### S12-T004 — Hardening: rate-limit & validasi input halaman RBAC management
**Status:** todo
**Dependency:** S11-T011 (done)
**Definition of Done:** Halaman Permission Matrix dan Role Permission Matrix tahan terhadap submit massal/abuse.

**Gate keluar Sprint 12:** Semua S12-T001 s/d S12-T004 `done`.
...
> Catatan: Task S13-T001 s/d S13-T009 mengikuti UAT per-role yang sudah dirancang di `Qwen_markdown` asli (NOC, Helpdesk, FOP, Teknisi, Sales, dst — termasuk S13-T010 POP Admin, S13-T011 Flow Manual sampai Pembayaran, S13-T012 Flow Import, S13-T013 Final Review, S13-T014 Release Readiness yang sudah lengkap di dokumen sumber). Agent **WAJIB membaca task tersebut langsung dari `Qwen_markdown` asli** karena checklist UAT per-role sudah detail di sana — dokumen ini tidak menduplikasi isinya untuk menghindari drift antara dua sumber.

### S13-T010 — UAT Flow POP Admin
**Status:** todo
**Dependency:** S12-T003 (done)
*(checklist & acceptance criteria: ikuti persis isi `Qwen_markdown` S13-T010)*

### S13-T011 — UAT Flow Pelanggan Manual sampai Pembayaran
**Status:** todo
**Dependency:** S13-T010 (done)
*(checklist & acceptance criteria: ikuti persis isi `Qwen_markdown` S13-T011)*

### S13-T012 — UAT Flow Import Pelanggan sampai Aktivasi
**Status:** todo
**Dependency:** S13-T011 (done)
*(checklist & acceptance criteria: ikuti persis isi `Qwen_markdown` S13-T012)*

### S13-T013 — Final Review MVP_SUCCESS_CHECKLIST.md
**Status:** todo
**Dependency:** S13-T012 (done)
*(checklist & acceptance criteria: ikuti persis isi `Qwen_markdown` S13-T013)*

### S13-T014 — Release Readiness Checklist
**Status:** todo
**Dependency:** S13-T013 (done)
*(checklist & acceptance criteria: ikuti persis isi `Qwen_markdown` S13-T014)*

**Gate keluar Sprint 13:** Semua task `done` DAN `MVP_SUCCESS_CHECKLIST.md` menyatakan layak rilis.

---

## 9. Definition of Done — GLOBAL (berlaku semua task Sprint 9–13)
...
4. `Qwen_markdown` (roadmap asli Sprint 9–13)
5. `implementation-plan-registrasi-survey-verifikasi.md`
6. `spesifikasi-pop-distribusi-cid.md`

Jika dokumen ini (level 2) berbeda dengan `Qwen_markdown` (level 4) soal detail checklist UAT Sprint 13, **`Qwen_markdown` yang dipakai untuk isi checklist**, karena dokumen ini sengaja tidak menduplikasi UAT detail (lihat catatan di §8). Untuk aturan arsitektur (role/scope/permission format), dokumen ini yang menjadi acuan utama.