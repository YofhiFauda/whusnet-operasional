...
|---|---|---|
| ADHOC-68 | **Skema Upgrade/Downgrade Paket Internet (prorate + deposit)** — analisa & rancangan dulu, **di luar sprint aktif**, belum diimplementasi. Rancangan: `docs/plan/upgrade-downgrade/analisa-upgrade-downgrade-paket.md` | **Terbuka** — dianalisa 2026-09-15, implementasi belum dimulai |
| ADHOC-69 | **Skema Putus Langganan (invoice+denda otomatis, master alasan, kolom pendaftar)** — analisa & rancangan dulu, **di luar sprint aktif**, belum diimplementasi. Rancangan: `docs/plan/billing/analisa-rancangan-putus-langganan.md` | **Terbuka** — dianalisa 2026-09-15, implementasi belum dimulai |
