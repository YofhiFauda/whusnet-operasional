<aside class="w-64 bg-surface border-r border-border h-screen sticky top-0 hidden md:flex flex-col transition-all duration-300" :class="{ 'w-16': !sidebarOpen, 'w-64': sidebarOpen }">
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-2">
        ...
        <a href="{{ route('customers.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('customers.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('surveys.queue') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('surveys.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('verifications.queue') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('verifications.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('invoices.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('invoices.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('payments.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('payments.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('reports.customers.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('reports.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('master.paket.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('master.paket.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        @if(auth()->user()->hasPermission('packages.view'))
        <a href="{{ route('master.sla-timeline.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('master.sla-timeline.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
        ...
        <a href="{{ route('users.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('users.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="flex-shrink-0"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        ...
        <a href="{{ route('audit-logs.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-md {{ request()->routeIs('audit-logs.*') ? 'bg-primary-soft text-primary-hover font-semibold' : 'text-text-secondary hover:bg-surface-muted hover:text-text-main' }}">
