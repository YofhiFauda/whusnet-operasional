{{-- z-[20] literal — lihat catatan `z-drawer` di components/ui/drawer.blade.php --}}
<header class="h-16 bg-surface border-b border-border flex items-center justify-between px-4 sm:px-6 sticky top-0 z-[20]">
    ...
    <div class="flex items-center gap-4">
        <!-- Dark Mode Toggle -->
        <button @click="dark = !dark; localStorage.setItem('whusnet-theme', dark ? 'dark' : 'light')" class="p-2 text-text-secondary hover:bg-surface-muted rounded-md" aria-label="Toggle Dark Mode">
