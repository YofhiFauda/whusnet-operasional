            ...
            show(type, title, description = '', duration = 5000) {
                ...
                switch (type) {
                    ...
                    case 'error':
                        ...
                        iconHtml = `<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`;
                        break;
                    case 'warning':
                ...
                toast.innerHTML = `
                    <div class="flex-shrink-0 p-1.5 rounded-full ${iconClass}">
                        ${iconHtml}
                    </div>
                    <div class="flex-1 pt-0.5 min-w-0 pb-1">
                        <div class="text-sm font-semibold text-slate-800 break-words">${title}</div>
