                    ...
                    <tbody class="divide-y divide-border">
                        ...
                        <tr class="hover:bg-surface-muted/50 transition-colors duration-150">
                            ...
                            <td class="px-4 py-3 text-xs font-semibold font-mono text-text-secondary">
                                {{ $tek['task_count'] }} Task
                                {{-- Pecahan tunggakan ditampilkan terpisah: "3 Task" yang
                                     semuanya sisa 3 hari lalu bukan beban yang sama dengan
                                     "3 Task" hari ini, dan itu yang menentukan boleh-tidaknya
                                     teknisi ini dapat task baru. --}}
