                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700/50 dark:hover:bg-slate-800/50 transition-colors align-top" id="fop-task-row-{{ $task->id }}" data-pop-id="{{ $task->pop_id }}">
                            ...
                            <td class="px-3 py-2 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    {{-- URL update dikirim dari server (route()), bukan dirakit
                                         `url('/fop-tasks') + '/' + id` di getter formAction.
                                         ADHOC-20 langkah 3. --}}
    ...
    <div x-show="modal.open" 
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-surface border border-border w-full max-w-2xl rounded-md shadow-lg relative z-10" 
                ...
                {{-- Penjaga submit: kalau `action` gagal terisi (formAction kosong,
                     atau binding tak pernah dievaluasi), form TIDAK boleh jalan —
                     tanpa action browser POST ke URL halaman ini, yaitu
                     POST /fop-tasks = membuat task baru diam-diam padahal user
                     mungkin sedang mengedit. Lebih baik berhenti dengan pesan.
                     ADHOC-20 langkah 3. --}}
