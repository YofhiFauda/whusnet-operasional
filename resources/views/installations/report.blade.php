...
<div class="mb-6">
    <nav class="flex text-xs font-semibold text-slate-400 uppercase tracking-wider gap-2">
        <a href="{{ route('verifications.queue') }}" class="hover:text-slate-700 transition-colors">Antrean Pemasangan</a>
        <span>/</span>
        <span class="text-slate-600">Lapor Pemasangan</span>
    </nav>
</div>
...
<form action="{{ route('customers.installation.store', $customer->id) }}" method="POST" enctype="multipart/form-data" id="wizard-form" class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
        <div class="flex items-center justify-between mb-3">
            <div>
                <h3 class="text-sm font-bold text-slate-800 uppercase tracking-wider">Kelengkapan Laporan Pemasangan</h3>
            ...
            <div class="text-right">
                ...
                <span class="text-xs text-slate-400 block mt-0.5"><span id="filled-fields-count" class="data-text">0</span> dari <span id="total-fields-count" class="data-text">6</span> field terisi</span>
            </div>
        </div>
        ...
        <div class="lg:col-span-1 flex flex-col gap-4">
            <div class="bg-white border border-slate-200 rounded-lg p-5 shadow-sm space-y-5">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Step 2 -->
                    <button type="button" onclick="goToStep(2)" id="step-nav-2" class="w-full text-left p-3.5 rounded-lg border border-green-200 bg-green-50/10 transition-all group focus:outline-none">
                        <div class="flex items-start gap-3">
                    ...
                    <!-- Step 4 -->
                    <button type="button" onclick="goToStep(4)" id="step-nav-4" class="w-full text-left p-3.5 rounded-lg border border-green-200 bg-green-50/10 transition-all group focus:outline-none">
                        <div class="flex items-start gap-3">
                    ...
                    <!-- Step 5 -->
                    <button type="button" onclick="goToStep(5)" id="step-nav-5" class="w-full text-left p-3.5 rounded-lg border border-red-100 bg-red-50/10 hover:bg-red-50/20 transition-all group focus:outline-none">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <span class="block text-xs font-bold text-slate-700 group-hover:text-slate-900">5. Laporan Pemasangan</span>
                                <span id="step-nav-status-5" class="text-[9px] font-bold block mt-1 uppercase tracking-wider text-red-600">Belum Lengkap</span>
                                <span id="step-nav-missing-5" class="text-[9px] text-slate-400 block mt-1 leading-relaxed whitespace-pre-wrap">Wajib diisi</span>
                            </div>
                        </div>
                    </button>

                    <!-- Step 6 -->
                    <button type="button" onclick="goToStep(6)" id="step-nav-6" class="w-full text-left p-3.5 rounded-lg border border-red-100 bg-red-50/10 hover:bg-red-50/20 transition-all group focus:outline-none">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <span class="block text-xs font-bold text-slate-700 group-hover:text-slate-900">6. Laporan Uji (Speedtest)</span>
                                <span id="step-nav-status-6" class="text-[9px] font-bold block mt-1 uppercase tracking-wider text-red-600">Belum Lengkap</span>
                                <span id="step-nav-missing-6" class="text-[9px] text-slate-400 block mt-1 leading-relaxed whitespace-pre-wrap"></span>
                            </div>
                        </div>
                    </button>
                </div>
        ...
        <div class="lg:col-span-3 bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden min-h-[480px] flex flex-col justify-between">
            ...
            <div class="p-6 md:p-8 flex-1">
                ...
                <div id="step-panel-2" class="step-panel space-y-6 hidden">
                    <div class="border-b border-slate-100 pb-3 mb-6">
                        <h4 class="text-sm font-bold text-slate-800 uppercase tracking-wider">2. DOKUMEN LAMPIRAN</h4>
                        <p class="text-xs text-slate-400 mt-1">Dokumen dan foto lokasi yang dilampirkan sebelumnya.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="border border-slate-200 bg-slate-50 rounded-lg p-5 flex flex-col justify-between shadow-sm relative opacity-90">
                            @if($customer->foto_ktp)
                                <div class="text-center py-2 flex flex-col items-center justify-center">
                                    <div class="relative inline-block w-full">
                                        <img class="max-h-32 max-w-full rounded-lg object-contain border border-slate-200 shadow-sm mx-auto cursor-pointer hover:opacity-90" src="{{ asset('storage/' . $customer->foto_ktp) }}" alt="Preview Foto KTP" onclick="window.open('{{ asset('storage/' . $customer->foto_ktp) }}', '_blank')">
                                    </div>
                            ...
                            @else
                                <div class="text-center py-4">
                                    <span class="block text-xs font-bold text-amber-600 uppercase">FOTO KTP KOSONG</span>
                                    <span class="block text-[10px] text-slate-400 mt-1">Belum diupload saat registrasi</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="border border-slate-200 bg-slate-50 rounded-lg p-5 flex flex-col justify-between shadow-sm relative opacity-90">
                            @if($customer->latestSurvey && $customer->latestSurvey->house_photo)
                                <div class="text-center py-2 flex flex-col items-center justify-center">
                                    <div class="relative inline-block w-full">
                                        <img class="max-h-32 max-w-full rounded-lg object-contain border border-slate-200 shadow-sm mx-auto" src="{{ asset('storage/' . $customer->latestSurvey->house_photo) }}" alt="Preview Foto Rumah">
                                    </div>
                                    <span class="block text-xs font-bold text-slate-700 mt-3 uppercase">FOTO RUMAH</span>
                                </div>
                            @else
                                <div class="text-center py-4">
                                    <span class="block text-xs font-bold text-slate-700 uppercase">FOTO RUMAH KOSONG</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="border border-slate-200 bg-slate-50 rounded-lg p-5 flex flex-col justify-between shadow-sm relative opacity-90">
                            @if($customer->latestSurvey && $customer->latestSurvey->survey_photo)
                                <div class="text-center py-2 flex flex-col items-center justify-center">
                                    <div class="relative inline-block w-full">
                                        <img class="max-h-32 max-w-full rounded-lg object-contain border border-slate-200 shadow-sm mx-auto" src="{{ asset('storage/' . $customer->latestSurvey->survey_photo) }}" alt="Preview Foto ODP">
                                    </div>
                                    <span class="block text-xs font-bold text-slate-700 mt-3 uppercase">FOTO ODP TERDEKAT</span>
                                </div>
                            @else
                                <div class="text-center py-4">
                                    <span class="block text-xs font-bold text-slate-700 uppercase">FOTO ODP KOSONG</span>
                                </div>
                            @endif
                        </div>
                ...
                <div id="step-panel-4" class="step-panel space-y-6 hidden">
                    <div class="border-b border-slate-100 pb-3 mb-6">
                        ...
                        <p class="text-xs text-slate-400 mt-1">Data teknis hasil pantauan di lapangan saat survey.</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-xs font-semibold text-slate-500 bg-slate-50 p-5 rounded-lg border border-slate-100">
                        <div>
                            <span class="block mb-1 uppercase tracking-wide text-[10px] text-slate-400">ODP TERDEKAT</span>
                            <span class="block text-sm font-mono text-slate-800">{{ $customer->latestSurvey->nearest_odp ?? '-' }}</span>
                        </div>
                        
                        <div>
                            <span class="block mb-1 uppercase tracking-wide text-[10px] text-slate-400">ESTIMASI KABEL (METER)</span>
                            <span class="block text-sm font-mono text-slate-800">{{ $customer->latestSurvey->cable_estimation_meter ?? '0' }} Meter</span>
                        </div>

                        <div class="md:col-span-2 pt-4 border-t border-slate-200">
                            <span class="block mb-1 uppercase tracking-wide text-[10px] text-slate-400">CATATAN SURVEY / TINGKAT KESULITAN</span>
                            <span class="block text-sm text-slate-800 whitespace-pre-wrap">{{ $customer->latestSurvey->survey_note ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="step-panel-5" class="step-panel space-y-6 hidden">
                    <div class="border-b border-slate-100 pb-3 mb-6">
                        <h4 class="text-sm font-bold text-slate-800 uppercase tracking-wider">5. LAPORAN PEMASANGAN & PERANGKAT</h4>
                        <p class="text-xs text-slate-400 mt-1">Masukkan data perangkat dan detail teknis instalasi jaringan.</p>
                    </div>
                    ...
                    <div class="bg-amber-50 border border-amber-200 text-amber-800 text-xs rounded-lg p-4 mb-4 flex flex-col gap-1.5 shadow-sm">
                        <div class="flex items-center gap-2 font-bold uppercase tracking-wider text-amber-900 text-sm">
                        ...
                        <p class="font-semibold text-slate-700 mt-1">Catatan dari Admin Verifikasi:</p>
                        <p class="bg-white border border-amber-100 p-3 rounded-md font-mono text-slate-700 whitespace-pre-wrap mt-1 leading-relaxed">{{ $failedInstallation->installation_note }}</p>
                    </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-xs font-semibold text-slate-500">
                        ...
                        <div class="md:col-span-2">
                            <label for="installation_status" class="block mb-2 uppercase tracking-wide">STATUS PEMASANGAN <span class="text-red-500">*</span></label>
                            <select name="installation_status" id="installation_status" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25">
                        ...
                        <div class="md:col-span-2 border-t border-slate-100 pt-4 mt-2">
                            <h5 class="font-bold text-slate-700 uppercase tracking-wider mb-4">Informasi Perangkat</h5>
                        </div>

                        <!-- Jenis Perangkat -->
                        <div>
                            <label for="device_type" class="block mb-2 uppercase tracking-wide">JENIS PERANGKAT <span class="text-red-500">*</span></label>
                            <select name="device_type" id="device_type" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25">
                        ...
                        <!-- Mode Koneksi -->
                        <div>
                            <label for="connection_mode" class="block mb-2 uppercase tracking-wide">MODE KONEKSI <span class="text-red-500">*</span></label>
                            <select name="connection_mode" id="connection_mode" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25">
                        ...
                        <!-- Merk & Tipe -->
                        <div>
                            <label for="brand" class="block mb-2 uppercase tracking-wide">MERK</label>
                            <input type="text" name="brand" id="brand" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" placeholder="ZTE / Huawei / Dll">
                        </div>
                        <div>
                            <label for="model" class="block mb-2 uppercase tracking-wide">TIPE</label>
                            <input type="text" name="model" id="model" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" placeholder="Contoh: F609">
                        </div>

                        <!-- Serial & MAC -->
                        <div>
                            <label for="serial_number" class="block mb-2 uppercase tracking-wide">SERIAL NUMBER <span class="text-red-500">*</span></label>
                            <input type="text" name="serial_number" id="serial_number" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        <div>
                            <label for="mac_address" class="block mb-2 uppercase tracking-wide">MAC ADDRESS</label>
                            <input type="text" name="mac_address" id="mac_address" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" placeholder="00:11:22:33:44:55">
                        </div>

                        <!-- PPPoE & IP -->
                        <div>
                            <label for="pppoe_username" class="block mb-2 uppercase tracking-wide">USERNAME PPPOE</label>
                            <input type="text" name="pppoe_username" id="pppoe_username" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        <div>
                            <label for="pppoe_password" class="block mb-2 uppercase tracking-wide">PASSWORD PPPOE</label>
                            <input type="text" name="pppoe_password" id="pppoe_password" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        <div class="md:col-span-2">
                            <label for="ip_address" class="block mb-2 uppercase tracking-wide">IP ADDRESS (STATIK)</label>
                            <input type="text" name="ip_address" id="ip_address" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" placeholder="192.168.x.x">
                        </div>

                        <!-- WiFi -->
                        <div>
                            <label for="wifi_ssid" class="block mb-2 uppercase tracking-wide">SSID WIFI <span class="text-red-500">*</span></label>
                            <input type="text" name="wifi_ssid" id="wifi_ssid" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        <div>
                            <label for="wifi_password" class="block mb-2 uppercase tracking-wide">PASSWORD WIFI <span class="text-red-500">*</span></label>
                            <input type="text" name="wifi_password" id="wifi_password" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>

                        <div class="md:col-span-2 border-t border-slate-100 pt-4 mt-2">
                            <h5 class="font-bold text-slate-700 uppercase tracking-wider mb-4">Informasi Distribusi Jaringan (ODP/OLT)</h5>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="odp_number" class="block mb-2 uppercase tracking-wide">NOMOR ODP</label>
                                <input type="text" name="odp_number" id="odp_number" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" value="{{ $customer->latestSurvey->nearest_odp ?? '' }}">
                            </div>
                            <div>
                                <label for="odp_port" class="block mb-2 uppercase tracking-wide">NOMOR PORT ODP</label>
                                <input type="text" name="odp_port" id="odp_port" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                            </div>
                        </div>

                        <div class="grid grid-cols-3 gap-2">
                            <div>
                                <label for="olt_number" class="block mb-2 uppercase tracking-wide">NOMOR OLT</label>
                                <input type="text" name="olt_number" id="olt_number" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                            </div>
                            <div>
                                <label for="olt_slot" class="block mb-2 uppercase tracking-wide">SLOT OLT</label>
                                <input type="text" name="olt_slot" id="olt_slot" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                            </div>
                            <div>
                                <label for="olt_port" class="block mb-2 uppercase tracking-wide">PORT OLT</label>
                                <input type="text" name="olt_port" id="olt_port" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                            </div>
                        </div>
                        
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="vlan" class="block mb-2 uppercase tracking-wide">VLAN (JARINGAN)</label>
                                <input type="text" name="vlan" id="vlan" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                            </div>
                            <div>
                                <label for="router_number" class="block mb-2 uppercase tracking-wide">NOMOR ROUTER</label>
                                <input type="text" name="router_number" id="router_number" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900" placeholder="Diisi manual untuk Distribusi">
                            </div>
                        </div>

                        <div>
                            <label for="initial_attenuation" class="block mb-2 uppercase tracking-wide">REDAMAN AWAL PEMASANGAN (dBm)</label>
                            <input type="text" name="initial_attenuation" id="initial_attenuation" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <label for="installation_note" class="block mb-2 uppercase tracking-wide">CATATAN PEMASANGAN</label>
                            <textarea name="installation_note" id="installation_note" rows="2" class="w-full text-sm font-sans px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="step-panel-6" class="step-panel space-y-6 hidden">
                    <div class="border-b border-slate-100 pb-3 mb-6">
                        <h4 class="text-sm font-bold text-slate-800 uppercase tracking-wider">6. LAPORAN UJI KONEKSI (SPEEDTEST)</h4>
                        <p class="text-xs text-slate-400 mt-1">Masukkan hasil pengujian kecepatan untuk memastikan koneksi stabil.</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 text-xs font-semibold text-slate-500">
                        
                        <div class="grid grid-cols-2 gap-4 md:col-span-2 bg-slate-50 p-4 rounded-lg border border-slate-100">
                            <div>
                                <label for="test_download" class="block mb-2 uppercase tracking-wide">SPEED DOWNLOAD (Mbps) <span class="text-red-500">*</span></label>
                                <input type="number" step="0.01" name="test_download" id="test_download" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25">
                            </div>
                            <div>
                                <label for="test_upload" class="block mb-2 uppercase tracking-wide">SPEED UPLOAD (Mbps) <span class="text-red-500">*</span></label>
                                <input type="number" step="0.01" name="test_upload" id="test_upload" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/25">
                            </div>
                        </div>

                        <div>
                            <label for="latency_ms" class="block mb-2 uppercase tracking-wide">LATENCY (ms)</label>
                            <input type="number" step="0.1" name="latency_ms" id="latency_ms" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        
                        <div>
                            <label for="jitter_ms" class="block mb-2 uppercase tracking-wide">JITTER (ms)</label>
                            <input type="number" step="0.1" name="jitter_ms" id="jitter_ms" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>

                        <div>
                            <label for="packet_loss_percent" class="block mb-2 uppercase tracking-wide">PACKET LOSS (%)</label>
                            <input type="number" step="0.01" name="packet_loss_percent" id="packet_loss_percent" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
                        
                        <div>
                            <label for="actual_attenuation" class="block mb-2 uppercase tracking-wide">REDAMAN AKTUAL (dBm)</label>
                            <input type="text" name="actual_attenuation" id="actual_attenuation" class="w-full text-sm font-mono px-3 py-2 border border-slate-200 rounded-md bg-white text-slate-900">
                        </div>
            ...
            <div class="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('verifications.queue') }}" class="px-4 py-2 border border-slate-200 rounded-md bg-white text-slate-700 hover:bg-slate-50 transition-colors text-xs font-semibold cursor-pointer focus:outline-none">
                        Batal
                    </a>
                    ...
                    <button type="button" onclick="handleSubmit()" id="btn-submit" class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md transition-colors text-xs font-semibold cursor-pointer hidden focus:outline-none">
