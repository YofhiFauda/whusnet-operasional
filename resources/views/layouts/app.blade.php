                        ...
                        <div id="submenu-tagihan"
                            ...
                            <div class="submenu-inner mt-1 ml-3.5 pl-3 border-l border-slate-200/80 dark:border-slate-700/60 space-y-0.5 text-xs pr-1">
                                ...
                                <a href="{{ route('invoices.lunas') }}"
                                   class="block py-1.5 px-3 rounded-md transition-colors {{ Request::routeIs('invoices.lunas') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20' }}">
                                    Tagihan Lunas
                                </a>
