...
<form action="{{ route('master.pop.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white border border-slate-200 rounded-lg p-6 shadow-sm lg:col-span-2 space-y-5">
        <div class="border-b border-slate-100 pb-3">
            ...
            <p class="text-xs text-slate-400 mt-0.5">Definisikan kode unik, tipe, dan struktur organisasi POP di sini.</p>
        </div>
    ...
    <div class="space-y-6 lg:col-span-1">
        <div class="bg-white border border-slate-200 rounded-lg p-6 shadow-sm space-y-4">
            <div class="border-b border-slate-100 pb-3">
                ...
                <p class="text-xs text-slate-400 mt-0.5">Masukkan alamat fisik dan koordinat geografis presisi POP.</p>
            </div>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3" placeholder="Jl. Diponegoro No. 23, RT 02/05..."
                          class="w-full px-3 py-2 border @error('address') border-rose-500 focus:ring-rose-500 @else border-slate-300 focus:ring-sky-500 focus:border-sky-500 @enderror rounded-md text-sm text-slate-800 focus:outline-none focus:ring-1">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-[10px] text-rose-500 mt-1 font-semibold">{{ $message }}</p>
                @enderror
            </div>
