        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-slate-100 dark:border-slate-700/50 pt-5">
            ...
            <div>
                ...
                <select name="status" id="status" required 
                        class="w-full px-3 py-2 border @error('status') border-rose-500 focus:ring-rose-500 @else border-slate-300 dark:border-slate-600 focus:ring-sky-500 focus:border-sky-500 @enderror rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1 bg-white dark:bg-slate-800">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6 shadow-sm space-y-4">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3" placeholder="Jl. Diponegoro No. 23, RT 02/05..."
                          class="w-full px-3 py-2 border @error('address') border-rose-500 focus:ring-rose-500 @else border-slate-300 dark:border-slate-600 focus:ring-sky-500 focus:border-sky-500 @enderror rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1">{{ old('address', $pop->address) }}</textarea>
                @error('address')
                    <p class="text-[10px] text-rose-500 mt-1 font-semibold">{{ $message }}</p>
                @enderror
            </div>
