...
<x-warehouse.header active="custody" title="Tandai Status Perangkat (SN)" subtitle="Pembaruan status operasional jika perangkat modem / router rusak, hilang, atau dikarantina." backUrl="{{ route('warehouse.custody.index') }}" />
