...
<x-warehouse.header active="custody" title="Alihkan Perangkat Aktif (SN)" subtitle="Pengalihan kepemilikan perangkat serial number dari teknisi lama ke teknisi baru atau pengembalian ke gudang." backUrl="{{ route('warehouse.custody.index') }}" />
