        ...
        <?php $__currentLoopData = $customer->installations()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border border-border rounded-lg overflow-hidden">
                <div class="px-5 py-3 bg-surface-muted border-b border-border flex items-center justify-between">
                    <span class="text-xs font-bold text-text-main">Pemasangan - <?php echo e(\App\Support\IndonesianDate::date($installation->scheduled_date)); ?></span>
                    <?php
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
                    <div class="space-y-3">
                        <div class="flex justify-between border-b border-border py-1">
                            ...
                            <span class="font-semibold text-text-main"><?php echo e($installation->technicians ?: ($installation->technician->name ?? '-')); ?></span>
                        </div>
                        <?php if($installation->technician2): ?>
                        <div class="flex justify-between border-b border-border py-1">
                            <span class="text-text-muted">Teknisi 2</span>
                            <span class="font-semibold text-text-main"><?php echo e($installation->technician2->name); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if($installation->technician3): ?>
                        <div class="flex justify-between border-b border-border py-1">
                            <span class="text-text-muted">Teknisi 3</span>
                            <span class="font-semibold text-text-main"><?php echo e($installation->technician3->name); ?></span>
                        </div>
                        <?php endif; ?>
                        <div class="flex justify-between border-b border-border py-1">
                            <span class="text-text-muted">Jadwal</span>
                            <span class="font-semibold text-text-main"><?php echo e(\App\Support\IndonesianDate::date($installation->scheduled_date)); ?> <?php echo e($installation->scheduled_time ? substr($installation->scheduled_time, 0, 5) : ''); ?></span>
                        </div>
                        <div class="flex justify-between border-b border-border py-1">
                            <span class="text-text-muted">Tanggal Selesai</span>
                            <span class="font-semibold text-text-main"><?php echo e($installation->finished_date ? \App\Support\IndonesianDate::date($installation->finished_date) : '-'); ?></span>
                        </div>
                        <?php if($installation->start_time || $installation->end_time): ?>
                            <div class="flex justify-between border-b border-border py-1">
                                <span class="text-text-muted">Jam Pemasangan</span>
                                <span class="font-semibold text-text-main font-mono"><?php echo e($installation->start_time ? substr($installation->start_time, 0, 5) : '-'); ?> - <?php echo e($installation->end_time ? substr($installation->end_time, 0, 5) : '-'); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($installation->fop_id): ?>
                            <div class="flex justify-between border-b border-border py-1">
                                <span class="text-text-muted">ID FOP</span>
                                <span class="font-semibold text-text-main font-mono"><?php echo e($installation->fop_id); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($installation->assigned_at): ?>
                            <div class="flex justify-between border-b border-border py-1">
                                <span class="text-text-muted">Waktu Penugasan</span>
                                <span class="font-semibold text-text-main font-mono"><?php echo e(\App\Support\IndonesianDate::dateTime($installation->assigned_at)); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php
                        ...
                        <div class="pt-2">
                            ...
                            <p class="p-3 bg-surface-muted rounded border border-border italic"><?php echo e($installation->installation_note ?? 'Tidak ada catatan'); ?></p>
                        </div>
                    </div>
                    <div>
                        ...
                        <?php if($installation->installation_photo): ?>
                            <div class="border border-border rounded overflow-hidden shadow-sm">
                                <img src="<?php echo e(asset('storage/' . $installation->installation_photo)); ?>" alt="Foto Pemasangan" class="w-full object-cover max-h-64">
                                <div class="p-2 bg-surface-muted text-center">
                                    <a href="<?php echo e(asset('storage/' . $installation->installation_photo)); ?>" target="_blank" class="text-[10px] font-bold" style="color:var(--color-info)">LIHAT FULL RESOLUSI</a>
                                </div>
                            </div>
                        <?php else: ?>
...
<?php if($customer->customerTechnicalDetail): ?>
    ...
    ?>
    <?php if($tech->test_date || $tech->test_download || $tech->test_upload || $tech->latency_ms !== null): ?>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                ...
                <div class="border border-border rounded-lg p-4 bg-surface-muted flex flex-col justify-between">
                    <div>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center border-b border-border pb-1">
                                ...
                                <span class="font-bold text-text-main font-mono text-sm"><?php echo e($tech->test_download !== null ? number_format($tech->test_download, 2) . ' Mbps' : '-'); ?></span>
                            </div>
                            <div class="flex justify-between items-center border-b border-border pb-1">
                                <span class="text-text-muted">Upload</span>
                                <span class="font-bold text-text-main font-mono text-sm"><?php echo e($tech->test_upload !== null ? number_format($tech->test_upload, 2) . ' Mbps' : '-'); ?></span>
                            </div>
                            <?php if($tech->speed_conformity_percent !== null): ?>
                                <?php
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="px-1.5 py-0.5 rounded text-[10px] font-bold font-mono" style="<?php echo e($conformityStyle); ?>">
                                        <?php echo e(number_format($tech->speed_conformity_percent, 1)); ?>%
                                    </span>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="mt-3 text-[10px] text-text-muted font-mono">
                        Uji: <?php echo e($tech->test_date ? \App\Support\IndonesianDate::date($tech->test_date) : '-'); ?> <?php echo e($tech->test_time ? substr($tech->test_time, 0, 5) : ''); ?>
                ...
                <div class="border border-border rounded-lg p-4 bg-surface-muted flex flex-col justify-between">
                    <div>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center border-b border-border pb-1">
                                ...
                                <span class="font-semibold text-text-main font-mono"><?php echo e($tech->latency_ms !== null ? number_format($tech->latency_ms, 1) . ' ms' : '-'); ?></span>
                            </div>
                            <div class="flex justify-between items-center border-b border-border pb-1">
                                <span class="text-text-muted">Jitter</span>
                                <span class="font-semibold text-text-main font-mono"><?php echo e($tech->jitter_ms !== null ? number_format($tech->jitter_ms, 1) . ' ms' : '-'); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-text-muted">Packet Loss</span>
                                <span class="font-semibold text-text-main font-mono"><?php echo e($tech->packet_loss_percent !== null ? number_format($tech->packet_loss_percent, 2) . '%' : '0.00%'); ?></span>
                            </div>
                            <?php if($tech->initial_attenuation || $tech->actual_attenuation): ?>
                                <div class="flex justify-between items-center border-t border-border mt-1 pt-1">
                                    ...
                                    <span class="font-semibold text-text-main font-mono text-[10px]"><?php echo e($tech->initial_attenuation ?: '-'); ?> / <?php echo e($tech->actual_attenuation ?: '-'); ?> dBm</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="mt-3 flex items-center justify-between">
                        ...
                        <div class="flex gap-0.5" style="color:var(--color-warning)">
                            <?php if($tech->quality_score): ?>
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <svg class="h-3 w-3 <?php echo e($i <= $tech->quality_score ? 'fill-current' : 'text-text-muted'); ?>" viewBox="0 0 20 20" fill="none" stroke="currentColor">
                ...
                <div class="border border-border rounded-lg p-4 bg-surface-muted flex flex-col justify-between">
                    <div>
                        ...
                        <?php if($tech->speedtest_photo): ?>
                            <div class="border border-border rounded overflow-hidden shadow-sm max-h-24 bg-surface relative group">
                                <img src="<?php echo e(asset('storage/' . $tech->speedtest_photo)); ?>" alt="Foto Speedtest" class="w-full object-cover max-h-24">
                                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                                    <a href="<?php echo e(asset('storage/' . $tech->speedtest_photo)); ?>" target="_blank" class="text-[9px] bg-surface text-text-main font-bold px-2 py-1 rounded shadow">LIHAT FULL</a>
                                </div>
                            </div>
                        <?php else: ?>
                    ...
                    <?php if($tech->speedtest_photo): ?>
                        <div class="mt-2 text-right">
                            <a href="<?php echo e(asset('storage/' . $tech->speedtest_photo)); ?>" target="_blank" class="text-[10px] font-bold" style="color:var(--color-info)">Buka Gambar ↗</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<div id="installation-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity z-50 flex items-center justify-center p-4 hidden">
    <div class="bg-surface rounded-lg shadow-xl border border-border w-full max-w-2xl overflow-hidden transform transition-all">
        ...
        <form action="<?php echo e(route('customers.installation.store', $customer->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label class="inline-flex items-center">
                            <input type="radio" name="installation_status" value="scheduled" style="accent-color:var(--color-info)" <?php echo e(!$latestInst || $latestInst->installation_status === 'scheduled' ? 'checked' : ''); ?>>
                            <span class="ml-2 text-xs text-text-main">Terjadwal</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="installation_status" value="in_progress" style="accent-color:var(--color-info)" <?php echo e($latestInst && $latestInst->installation_status === 'in_progress' ? 'checked' : ''); ?>>
                            <span class="ml-2 text-xs text-text-main">Proses</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="installation_status" value="completed" style="accent-color:var(--color-info)" <?php echo e($latestInst && $latestInst->installation_status === 'completed' ? 'checked' : ''); ?>>
                            <span class="ml-2 text-xs text-text-main">Selesai</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="installation_status" value="failed" style="accent-color:var(--color-info)" <?php echo e($latestInst && $latestInst->installation_status === 'failed' ? 'checked' : ''); ?>>
                ...
                <div>
                    ...
                    <input type="text" name="fop_id" id="fop_id_inst" placeholder="FOP-2026-..." value="<?php echo e($latestInst ? $latestInst->fop_id : ''); ?>"
                           class="w-full px-3 py-2 bg-surface border border-border rounded-md shadow-sm focus:ring-primary/25 focus:border-primary text-xs font-mono text-text-main">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="installation_note" id="installation_note" rows="3" placeholder="Tuliskan catatan pemasangan pelanggan..."
                              class="w-full px-3 py-2 bg-surface border border-border rounded-md shadow-sm focus:ring-primary/25 focus:border-primary text-xs text-text-main"><?php echo e($latestInst ? $latestInst->installation_note : ''); ?></textarea>
                </div>
...
<div id="test-report-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity z-50 flex items-center justify-center p-4 hidden">
    <div class="bg-surface rounded-lg shadow-xl border border-border w-full max-w-2xl overflow-hidden transform transition-all">
        ...
        <form action="<?php echo e(route('customers.test-report.store', $customer->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
