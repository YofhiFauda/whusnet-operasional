        ...
        <?php $__currentLoopData = $customer->installations()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                <div class="px-5 py-3.5 bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 flex flex-wrap gap-2 justify-between items-center">
                    <span class="text-xs font-bold text-slate-900 dark:text-slate-100">Pemasangan — <?php echo e($tglMulai !== '-' ? $tglMulai : $tglJadwal); ?></span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
                        <div class="space-y-2.5">
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <span class="font-semibold text-slate-900 dark:text-slate-100 searchable-text"><?php echo e($installation->fop?->name ?: ($installation->fop_id ?: ($installTask?->fop?->name ?: '-'))); ?></span>
                            </div>
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <span class="font-mono font-semibold text-slate-900 dark:text-slate-100 searchable-text">
                                    <?php echo e($installation->assigned_at ? \App\Support\IndonesianDate::dateTime($installation->assigned_at) . ' WIB' : ($installTask?->created_at ? \App\Support\IndonesianDate::dateTime($installTask->created_at) . ' WIB' : ($installation->created_at ? \App\Support\IndonesianDate::dateTime($installation->created_at) . ' WIB' : '-'))); ?>
                            ...
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <span class="font-semibold text-slate-900 dark:text-slate-100 searchable-text">
                                    <?php echo e($tglJadwal); ?><?php echo e($installation->scheduled_time ? ' — ' . substr($installation->scheduled_time, 0, 5) . ' WIB' : ($installTask?->scheduled_at ? ' — ' . $installTask->scheduled_at->format('H:i') . ' WIB' : '')); ?>
                            ...
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <span class="font-semibold text-slate-900 dark:text-slate-100 searchable-text">
                                    <?php echo e($tglMulai); ?> — <?php echo e($installation->start_time ? substr($installation->start_time, 0, 5) . ' WIB' : '-'); ?>
                        ...
                        <div class="space-y-2.5">
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <span class="font-semibold text-slate-900 dark:text-slate-100 searchable-text"><?php echo e($teknisiUtama); ?></span>
                            </div>
                            <div class="flex justify-between gap-3 py-1 border-b border-slate-100 dark:border-slate-700/50">
