<?php $__env->startSection('title', 'Tambah POP Baru - Whusnet Operasional'); ?>
<?php $__env->startSection('page_title', 'Tambah POP / Cabang Baru'); ?>
...
<!-- Form Container -->
<form action="<?php echo e(route('master.pop.store')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6 shadow-sm lg:col-span-2 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="code" id="code" value="<?php echo e(old('code')); ?>" required placeholder="Contoh: POP-SMN-01"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required placeholder="Contoh: POP Cabang Sleman"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-slate-100 dark:border-slate-700/50 pt-5">
            ...
            <div>
                ...
                <input type="text" name="pop_code" id="pop_code" value="<?php echo e(old('pop_code')); ?>" required placeholder="Contoh: SMN"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="registration_prefix" id="registration_prefix" value="<?php echo e(old('registration_prefix')); ?>" required placeholder="Contoh: C"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="cid_prefix" id="cid_prefix" value="<?php echo e(old('cid_prefix')); ?>" required placeholder="Contoh: D"
...
unset($__errorArgs, $__bag); ?> rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1 bg-white dark:bg-slate-800">
                    ...
                    <option value="pusat" <?php echo e(old('type') === 'pusat' ? 'selected' : ''); ?>>Pusat</option>
                    <option value="cabang" <?php echo e(old('type') === 'cabang' ? 'selected' : ''); ?>>Cabang</option>
                    <option value="mini_pop" <?php echo e(old('type') === 'mini_pop' ? 'selected' : ''); ?>>Mini POP</option>
                </select>
        ...
        <div class="border-t border-slate-100 dark:border-slate-700/50 pt-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="pic_name" id="pic_name" value="<?php echo e(old('pic_name')); ?>" placeholder="Contoh: Ahmad Subardjo"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="pic_phone" id="pic_phone" value="<?php echo e(old('pic_phone')); ?>" placeholder="Contoh: 08123456789"
...
unset($__errorArgs, $__bag); ?> rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" name="city" id="city" value="<?php echo e(old('city')); ?>" placeholder="Sleman"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="district" id="district" value="<?php echo e(old('district')); ?>" placeholder="Depok"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="village" id="village" value="<?php echo e(old('village')); ?>" placeholder="Caturtunggal"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-3 border-t border-slate-100 dark:border-slate-700/50 pt-4">
                <div>
                    ...
                    <input type="text" name="latitude" id="latitude" value="<?php echo e(old('latitude')); ?>" placeholder="-7.782"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="longitude" id="longitude" value="<?php echo e(old('longitude')); ?>" placeholder="110.372"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/yopi/whusnet/whusnet-operasional/resources/views/master/pop/create.blade.php ENDPATH**/ ?>