                ...
                <div class="space-y-1">
                    ...
                    <div class="space-y-1">
                        ...
                        <div id="submenu-pelanggan"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs
                                    <?php echo e(Request::is('customers*') || Request::is('surveys*') || Request::is('verifications*') ? '' : 'hidden'); ?>">
                            ...
                            <a href="<?php echo e(route('surveys.queue')); ?>"
                               class="flex items-center justify-between py-2 px-3 rounded-md transition-colors
                                ...
                                <?php if(isset($badge_survey_count) && $badge_survey_count > 0): ?>
                                    <span class="bg-sky-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full"><?php echo e($badge_survey_count); ?></span>
                                <?php endif; ?>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('verifications.queue')); ?>"
                               class="flex items-center justify-between py-2 px-3 rounded-md transition-colors
                                ...
                                <?php if(isset($badge_verification_count) && $badge_verification_count > 0): ?>
                                    <span class="bg-sky-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full"><?php echo e($badge_verification_count); ?></span>
                                <?php endif; ?>
                            </a>
                            <?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-tagihan', 'chevron-tagihan')"
                            ...
                            <svg id="chevron-tagihan"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e(Request::is('invoices*') ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-tagihan"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e(Request::is('invoices*') ? '' : 'hidden'); ?>">
                            <a href="<?php echo e(route('invoices.belum-lunas')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('invoices.belum-lunas') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Tagihan Belum Lunas
                            </a>
                            <a href="<?php echo e(route('invoices.lunas')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('invoices.lunas') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Tagihan Lunas
                            </a>
                            <a href="<?php echo e(route('invoices.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('invoices.index') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Semua Tagihan
                            </a>
                            <?php if(auth()->user()->hasPermission('payments.view')): ?>
                            <a href="<?php echo e(route('payments.overpay')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('payments.overpay') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                    ...
                    <a href="<?php echo e(route('payments.index')); ?>" title="Pembayaran"
                       class="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              <?php echo e(Request::is('payments*') && !Request::is('payments/overpay') ? 'bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 font-semibold' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-slate-50'); ?>">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5 shrink-0 <?php echo e(Request::is('payments*') && !Request::is('payments/overpay') ? 'text-sky-600 dark:text-sky-400' : 'text-slate-400 dark:text-slate-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="<?php echo e(route('collectors.index')); ?>" title="Kolektor"
                       class="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              <?php echo e(Request::is('collectors*') || Request::is('collector-batch*') ? 'bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 font-semibold' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-700/60 hover:text-slate-900 dark:hover:text-slate-50'); ?>">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5 shrink-0 <?php echo e(Request::is('collectors*') || Request::is('collector-batch*') ? 'text-sky-600 dark:text-sky-400' : 'text-slate-400 dark:text-slate-500'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="<?php echo e(route('collector-worklist.index')); ?>" title="Worklist Saya"
                       class="flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-tasks', 'chevron-tasks')"
                            ...
                            <svg id="chevron-tasks"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e(Request::is('tasks*') || Request::is('fop*') ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-tasks"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e(Request::is('tasks*') || Request::is('fop*') ? '' : 'hidden'); ?>">
                            <a href="<?php echo e(route('fop.dashboard')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('fop.dashboard') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                FOP Dashboard
                            </a>
                            <?php if(auth()->user()->hasPermission('fop_tasks.view')): ?>
                            <a href="<?php echo e(route('fop-tasks.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('fop-tasks.index') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Task FOP
                            </a>
                            <a href="<?php echo e(route('fop-tasks.history')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('fop-tasks.history') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Riwayat Task FOP
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('task.view.own')): ?>
                            <a href="<?php echo e(route('tasks.own')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('tasks.own') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Task Saya
                            </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-ticketing', 'chevron-ticketing')"
                            ...
                            <svg id="chevron-ticketing"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e((Request::is('tickets*') || Request::is('noc/*')) ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-ticketing"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e((Request::is('tickets*') || Request::is('noc/*')) ? '' : 'hidden'); ?>">
                            ...
                            <a href="<?php echo e(route('tickets.create')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('tickets.create') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Worksheet Helpdesk
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('noc.worksheet')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('noc.worksheet*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Worksheet NOC
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('noc.dashboard')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('noc.dashboard') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Dashboard NOC
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('tickets.selesai')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('tickets.selesai') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Ticket Selesai
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('tickets.dibatalkan.view')): ?>
                            <a href="<?php echo e(route('tickets.dibatalkan')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('tickets.dibatalkan') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Ticket Dibatalkan
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('tickets.history')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::routeIs('tickets.history') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                History Ticketing
                            </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-laporan', 'chevron-laporan')"
                            ...
                            <svg id="chevron-laporan"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e(Request::is('reports*') ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-laporan"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e(Request::is('reports*') ? '' : 'hidden'); ?>">
                            <a href="<?php echo e(route('reports.customers.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('reports/customers*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Laporan Pelanggan
                            </a>
                            <a href="<?php echo e(route('reports.invoices.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('reports/invoices*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Laporan Tagihan
                            </a>
                            <a href="<?php echo e(route('reports.payments.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('reports/payments*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Laporan Pembayaran
                            </a>
                            <a href="<?php echo e(route('reports.imports.index')); ?>"
                               class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('reports/imports*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">
                                Laporan Import Data
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-master', 'chevron-master')"
                            ...
                            <svg id="chevron-master"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e(Request::is('master*') ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-master"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e(Request::is('master*') ? '' : 'hidden'); ?>">
                            <?php if(auth()->user()->hasPermission('master_wilayah.view')): ?>
                            <a href="/master/wilayah" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/wilayah') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Data Wilayah</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('pops.view')): ?>
                            <a href="/master/pop" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/pop*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master POP/Cabang</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('master_distribusi.view')): ?>
                            <a href="/master/distribusi" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/distribusi*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Distribusi</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('packages.view')): ?>
                            <a href="/master/paket" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/paket*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Paket Internet</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('master_status_pelanggan.view')): ?>
                            <a href="/master/status-langganan" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/status-langganan') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Status Pelanggan</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('sla_timeline.view')): ?>
                            <a href="/master/sla-timeline" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/sla-timeline*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Timeline SLA</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('ticket_issue_categories.view')): ?>
                            <a href="/master/issue-categories" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/issue-categories*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Kategori Tiket</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('items.view')): ?>
                            <a href="/master/items" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/items*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Item (Barang)</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('item_categories.view')): ?>
                            <a href="/master/item-categories" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/item-categories*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Kategori Item</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('work_tools.view')): ?>
                            <a href="/master/work-tools" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('master/work-tools*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Master Alat Kerja</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="space-y-1">
                        <button onclick="toggleSubmenu('submenu-settings', 'chevron-settings')"
                            ...
                            <svg id="chevron-settings"
                                 class="chevron-icon h-3.5 w-3.5 shrink-0 transition-transform duration-200 <?php echo e(Request::is('users*') || Request::is('roles*') ? 'rotate-180 text-sky-600 dark:text-sky-400' : 'text-slate-300 dark:text-slate-600'); ?>"
                                 fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>
                        <div id="submenu-settings"
                             class="submenu-container mt-0.5 pl-9 pr-2 space-y-0.5 text-xs <?php echo e(Request::is('users*') || Request::is('roles*') ? '' : 'hidden'); ?>">
                            <?php if(auth()->user()->hasPermission('users.view')): ?>
                            <a href="/users" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('users*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Manajemen User &amp; POP</a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('roles.view')): ?>
                            <a href="<?php echo e(route('roles.index')); ?>" class="block py-2 px-3 rounded-md transition-colors <?php echo e(Request::is('roles*') ? 'sidebar-subitem-active' : 'text-slate-500 dark:text-slate-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50/50 dark:hover:bg-sky-900/20'); ?>">Role &amp; Permission</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
