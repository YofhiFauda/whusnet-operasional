                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex flex-col items-center gap-1">
                                    ...
                                    <?php if($invoice->remaining_amount > 0): ?>
                                        <span class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold <?php echo e($invoice->isPiutang() ? 'bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-500/20' : 'bg-sky-50 dark:bg-sky-500/10 text-sky-700 dark:text-sky-400 border-sky-200 dark:border-sky-500/20'); ?>">
                                            <?php echo e($invoice->isPiutang() ? 'Piutang' : 'Bulanan Berjalan'); ?>
