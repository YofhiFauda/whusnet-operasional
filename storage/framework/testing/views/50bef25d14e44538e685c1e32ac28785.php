...
>
    ...
    <div @click.self="show = false" class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        <div 
            ...
            class="relative transform overflow-hidden rounded-lg bg-surface text-left shadow-md transition-all w-full <?php echo e($maxWidthClass); ?> sm:my-8 border border-border"
        >
            <div class="px-4 py-4 border-b border-border flex justify-between items-center bg-surface-muted">
                <h3 class="text-lg font-semibold text-text-main" id="modal-title"><?php echo e($title); ?></h3>
...
<?php /**PATH /home/yopi/whusnet/whusnet-operasional/resources/views/components/ui/modal.blade.php ENDPATH**/ ?>