<?php $__env->startSection('title', 'Master Alat Kerja - Whusnet Operasional'); ?>
<?php $__env->startSection('page_title', 'Master Alat Kerja'); ?>
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-4 md:gap-6">
            <div class="text-center">
                ...
                <span class="text-lg font-bold text-slate-800 dark:text-slate-200 data-text"><?php echo e(\App\Models\WorkTool::count()); ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-5 mb-6 shadow-sm">
    <form action="<?php echo e(route('master.work-tools.index')); ?>" method="GET" class="flex flex-col lg:flex-row items-end lg:items-center justify-between gap-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full lg:max-w-2xl">
            <div>
                ...
                <div class="relative">
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Kode atau nama alat..."
        ...
        <div class="flex items-center gap-2 w-full lg:w-auto shrink-0 justify-end">
            ...
            <a href="<?php echo e(route('master.work-tools.index')); ?>" class="inline-flex items-center justify-center p-2 border border-slate-300 dark:border-slate-600 rounded-md shadow-sm text-sm font-medium text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors focus:outline-none cursor-pointer" title="Reset Filters">
        ...
        <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
            <thead class="bg-slate-50 dark:bg-slate-800/50">
                <tr>
                    ...
                    <?php if(auth()->user()->hasPermission('work_tools.update')): ?>
            ...
            <tbody class="bg-white dark:bg-slate-800 divide-y divide-slate-100 dark:divide-slate-700/50">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-mono text-slate-600 dark:text-slate-400"><?php echo e($tool->code); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-semibold text-slate-800 dark:text-slate-200"><?php echo e($tool->name); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($tool->note ?: '—'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <div class="flex items-center justify-center gap-2">
                            <a href="<?php echo e(route('master.work-tools.edit', $tool)); ?>" class="p-1 text-slate-400 dark:text-slate-500 hover:text-sky-600 hover:bg-sky-50 dark:hover:bg-sky-900/20 rounded-md transition-colors" title="Ubah Alat">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                            </a>

                            <form action="<?php echo e(route('master.work-tools.toggle', $tool)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/yopi/whusnet/whusnet-operasional/resources/views/master/work_tools/index.blade.php ENDPATH**/ ?>