<?php $__env->startSection('title', 'Tambah Kategori Issue - Whusnet Operasional'); ?>
<?php $__env->startSection('page_title', 'Tambah Kategori Issue'); ?>
...
<!-- Form Container -->
<form action="<?php echo e(route('master.ticket-issue-categories.store')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6 shadow-sm col-span-1 lg:col-span-2 space-y-5">
        <div class="border-b border-slate-100 dark:border-slate-700/50 pb-3">
            ...
            <p class="text-xs text-slate-400 dark:text-slate-500 mt-0.5">Lengkapi form berikut untuk menambahkan master kategori keluhan baru.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Lemot"
...
unset($__errorArgs, $__bag); ?> rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1 bg-white dark:bg-slate-800">
                    ...
                    <?php $__currentLoopData = \App\Enums\FopTaskPriority::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($priority->value); ?>" <?php echo e(old('default_priority') === $priority->value ? 'selected' : ''); ?>><?php echo e($priority->value); ?></option>
...
unset($__errorArgs, $__bag); ?> rounded-md text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1 bg-white dark:bg-slate-800">
                    <option value="prioritas" <?php echo e(old('sla_source', 'prioritas') === 'prioritas' ? 'selected' : ''); ?>>Prioritas</option>
                    <option value="paket" <?php echo e(old('sla_source') === 'paket' ? 'selected' : ''); ?>>Paket</option>
                </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/yopi/whusnet/whusnet-operasional/resources/views/master/ticket-issue-categories/create.blade.php ENDPATH**/ ?>