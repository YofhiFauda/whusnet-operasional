                            ...
                            <?php $__currentLoopData = $ticket->batchMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="bg-violet-50/50 dark:bg-violet-950/20 text-[11px] border-b border-violet-100 dark:border-violet-900/30">
                                    ...
                                    <td class="px-3 py-2">
                                        ...
                                        <span class="block font-mono text-[10px] text-sky-600 dark:text-sky-400"><?php echo e($member->cid ?: '—'); ?></span>
                                    </td>
                                    <td class="px-3 py-2 font-mono">
                                        <?php if($member->phone): ?>
                                            <a href="https://wa.me/<?php echo e($member->phone); ?>" target="_blank" rel="noopener" class="text-emerald-600 dark:text-emerald-400 hover:underline">
