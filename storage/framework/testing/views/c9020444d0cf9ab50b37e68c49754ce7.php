        ...
        <div class="bg-surface border border-border rounded-xl p-4 transition-all hover:border-violet-500/40 shadow-2xs">
            ...
            <div class="mt-2 flex items-center gap-3 text-xs">
                ...
                <span class="inline-flex items-center gap-1 text-sky-600 dark:text-sky-400 font-semibold font-mono">
                    <span class="w-2 h-2 rounded-full bg-sky-500"></span> Non-Cash: <?php echo e($transferCount); ?>
        ...
        <form action="<?php echo e(route('payments.index')); ?>" method="GET" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3">
                ...
                <div class="sm:col-span-2 lg:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" id="search" value="<?php echo e($search); ?>" placeholder="Nama, CID, No. Pembayaran, Invoice..." 
            ...
            <div class="flex items-center justify-between pt-2 border-t border-border/60">
                <div class="text-[11px] text-text-muted">
                    Menampilkan <span class="font-semibold text-text-main"><?php echo e($payments->firstItem() ?? 0); ?></span> - <span class="font-semibold text-text-main"><?php echo e($payments->lastItem() ?? 0); ?></span> dari <span class="font-semibold text-text-main"><?php echo e($payments->total()); ?></span> pembayaran
                </div>
                <div class="flex items-center gap-2">
                    <?php if($search !== '' || $popId !== '' || $dateFrom !== '' || $dateTo !== '' || $method !== '' || $status !== '' || $invoiceType !== ''): ?>
                        <a href="<?php echo e(route('payments.index')); ?>" class="px-3.5 py-1.5 border border-border bg-surface hover:bg-surface-muted text-text-secondary rounded-lg transition-colors text-xs font-semibold text-center">
                            Reset Filter
                        </a>
                    <?php endif; ?>
                ...
                <tbody class="divide-y divide-border">
                    <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-surface-muted/50 transition-colors">
                            ...
                            <!-- Payment Method -->
                            <td class="px-4 py-3.5 whitespace-nowrap">
                                <span class="px-2 py-0.5 text-[10px] font-bold rounded-md border uppercase tracking-wider <?php echo e($methodBadge); ?>">
                            ...
                            <td class="px-4 py-3.5 whitespace-nowrap">
                                ...
                                <?php endif; ?>
                                <div class="text-[10px] text-text-muted mt-0.5">by <?php echo e($payment->receiver->name ?? 'System'); ?></div>
                            </td>
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <span class="inline-flex items-center gap-1 px-2.5 py-0.5 text-[10px] font-bold rounded-full border <?php echo e($badgeClass); ?>">
                            ...
                            <td class="px-4 py-3.5 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <a href="<?php echo e(route('payments.receipt', $payment->id)); ?>" target="_blank" class="p-1 border border-border bg-surface hover:bg-surface-muted text-text-secondary rounded-md transition-colors text-xs" title="Cetak Struk Thermal">
                                        <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
