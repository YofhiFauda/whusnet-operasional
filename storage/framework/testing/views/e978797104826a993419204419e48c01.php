    ...
    <div class="bg-surface border border-border rounded-2xl overflow-hidden shadow-xs">
                ...
                <div class="space-y-0.5 text-xs">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start py-3 border-b border-border gap-1.5 sm:gap-4 select-text">
                        ...
                        <div class="flex-1 font-ui">
                            <?php if($ticketForBatch->batchMembers->isEmpty()): ?>
                            <p class="text-xs text-warning font-semibold">Belum ada pelanggan terdampak dicatat — cek halaman Worksheet Helpdesk (tiket <?php echo e($ticketForBatch->ticket_number); ?>).</p>
                            <?php else: ?>
                            <div class="bg-violet-50/70 dark:bg-violet-900/10 border border-violet-200/80 dark:border-violet-800/40 rounded-xl p-3 space-y-1.5 shadow-xs">
                                <p class="text-[10px] font-bold uppercase tracking-wider text-violet-600 dark:text-violet-400">
                                    <?php echo e($ticketForBatch->batchMembers->count()); ?> Pelanggan
                                </p>
                                <?php $__currentLoopData = $ticketForBatch->batchMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-xs">
                                    ...
                                    <span class="font-mono text-[11px] text-text-muted"><?php echo e($member->cid ?: '—'); ?></span>
                                    <span class="font-mono text-[11px] text-text-muted"><?php echo e($member->phone ?: '—'); ?></span>
                                </div>
        ...
        <div class="p-4 sm:p-5 border-t border-border space-y-6">
            ...
            <div class="pt-5 border-t border-border space-y-4 select-text">
                ...
                <div x-data class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs select-none">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 p-3.5">
                        ...
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($surveyPhotoUrl); ?>', label: 'Foto ODP Survey' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($surveyPhotoUrl); ?>" alt="Foto ODP Survey" class="h-full w-full object-cover">
                        ...
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($surveyHousePhotoUrl); ?>', label: 'Foto Rumah Pelanggan' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($surveyHousePhotoUrl); ?>" alt="Foto Rumah Customer" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <div class="pt-5 border-t border-border space-y-4 select-text">
                ...
                ?>
                <?php if($installPhotoUrl || $contractPhotoUrl || $signaturePhotoUrl): ?>
                <div x-data class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs select-none">
                    <div class="flex items-center gap-1.5 px-3.5 py-2.5 border-b border-border bg-surface-muted">
                        <svg class="h-3.5 w-3.5 text-sky-600 dark:text-sky-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 p-3.5">
                        <?php if($installPhotoUrl): ?>
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($installPhotoUrl); ?>', label: 'Foto Bukti Pemasangan' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($installPhotoUrl); ?>" alt="Foto Pemasangan" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
                        ...
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($contractPhotoUrl); ?>', label: 'Foto Kontrak / BA' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($contractPhotoUrl); ?>" alt="Foto Kontrak/BA" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
                        ...
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($signaturePhotoUrl); ?>', label: 'Foto Tanda Tangan' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($signaturePhotoUrl); ?>" alt="Foto Tanda Tangan" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <?php elseif($task->task_type->value === \App\Enums\TaskType::AMBIL_MODEM->value): ?>
            
            <?php echo $__env->make('tasks.partials.device-retrieval-report', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="pt-5 border-t border-border space-y-4 select-text">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                        <?php $__currentLoopData = $installedSerials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex justify-between items-center bg-violet-50/60 dark:bg-violet-950/30 border border-violet-200 dark:border-violet-900/50 p-3 rounded-xl shadow-xs">
                            <div>
                                <span class="text-violet-950 dark:text-violet-200 font-ui font-bold block"><?php echo e($tx->item->name); ?></span>
                                <span class="font-mono text-[11px] text-violet-700 dark:text-violet-400">
                                    <?php if(auth()->user()->hasPermission('warehouse_traceability.view') && $tx->serial): ?>
                                        <a href="<?php echo e(route('warehouse.traceability.index', ['sn' => $tx->serial->serial_number])); ?>" class="hover:underline font-bold">SN: <?php echo e($tx->serial->serial_number); ?></a>
                                    <?php else: ?>
                                        SN: <?php echo e($tx->serial?->serial_number ?? '—'); ?>
                ...
                ?>
                <?php if($opmPhotoUrl || $maintSpeedtestPhotoUrl): ?>
                <div x-data class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs select-none">
                    <div class="flex items-center gap-1.5 px-3.5 py-2.5 border-b border-border bg-surface-muted">
                        <svg class="h-3.5 w-3.5 text-sky-600 dark:text-sky-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812-1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 p-3.5">
                        <?php if($opmPhotoUrl): ?>
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($opmPhotoUrl); ?>', label: 'Foto OPM' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($opmPhotoUrl); ?>" alt="Foto OPM" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
                                <span class="text-white text-[10px] font-bold text-center font-ui">Foto OPM</span>
                            </div>
                        </button>
                        <?php endif; ?>
                        <?php if($maintSpeedtestPhotoUrl): ?>
                        <button type="button" @click="$dispatch('open-image-preview', { url: '<?php echo e($maintSpeedtestPhotoUrl); ?>', label: 'Foto Speedtest' })" class="group relative block w-full rounded-lg overflow-hidden aspect-square bg-slate-100 dark:bg-slate-800 border border-border hover:border-sky-500 transition-all cursor-pointer">
                            <img src="<?php echo e($maintSpeedtestPhotoUrl); ?>" alt="Foto Speedtest" class="h-full w-full object-cover">
                            <div class="absolute inset-0 flex items-end justify-center p-2 bg-slate-900/0 group-hover:bg-slate-900/60 backdrop-blur-0 group-hover:backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300">
