...
<div class="space-y-6 max-w-5xl mx-auto pb-12">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2 text-xs text-text-muted">
            <a href="<?php echo e(route('tickets.create')); ?>" class="hover:text-sky-600 transition-colors flex items-center gap-1">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-xs">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono font-bold text-sky-600 dark:text-sky-400 data-text"><?php echo e($ticket->fopTask->task_number); ?></span>
                            </div>
    ...
    <div class="bg-surface border border-amber-200 dark:border-amber-900/50 rounded-xl p-5 shadow-sm">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.cancel', $ticket)); ?>', null, 'Batalkan Tiket', 'Alasan pembatalan (wajib diisi)', true, 'Batalkan tiket ini? Tindakan ini gak bisa dibatalin balik.')"
            ...
            <div class="border border-border rounded-lg overflow-hidden bg-border shadow-xs">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
                    ...
                    <div class="bg-surface p-3 space-y-1">
                        ...
                        <div class="text-xs font-mono text-text-main truncate"><?php echo e($ticket->customer_phone ?: '—'); ?></div>
                    </div>
            ...
            <ul class="divide-y divide-border">
                <?php $__empty_1 = true; $__currentLoopData = optional($ticket->fopTask)->statusHistories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                        ...
                        <p class="text-xs font-semibold text-text-secondary mt-2">
                            oleh <span class="text-text-main"><?php echo e($history->changedByUser->name ?? 'Sistem'); ?></span>
                        </p>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
