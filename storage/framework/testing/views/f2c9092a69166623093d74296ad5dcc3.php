<?php $__env->startSection('title', 'Detail Ticket ' . $ticket->ticket_number . ' — ISP NOC'); ?>
<?php $__env->startSection('page_title', 'Detail Ticket ' . $ticket->ticket_number); ?>
...
<div class="space-y-6 max-w-6xl mx-auto pb-16">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div class="flex items-center gap-2 text-xs text-text-muted flex-wrap">
            <a href="<?php echo e(route('tickets.create')); ?>" class="hover:text-sky-600 dark:hover:text-sky-400 transition-colors flex items-center gap-1 font-medium">
            ...
            <span>/</span>
            <span class="font-mono font-bold <?php echo e($isBatch ? 'text-violet-600 dark:text-violet-400' : 'text-sky-600 dark:text-sky-400'); ?>"><?php echo e($ticket->ticket_number); ?></span>
            <?php if($isBatch): ?>
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div class="space-y-3 min-w-0">
                    <div class="flex items-center gap-2.5 flex-wrap">
                        ...
                        <span class="text-xs font-mono font-bold px-2.5 py-1 rounded-lg border <?php echo e($ticket->type->badgeClasses()); ?>">
                            <?php echo e($ticket->type->value); ?> — <?php echo e($ticket->type->label()); ?>
                        ...
                        <span class="text-xs font-bold px-2.5 py-1 rounded-lg border <?php echo e($ticket->statusBadgeClasses()); ?>">
                    ...
                    <div class="flex items-center gap-3 text-xs text-text-muted flex-wrap">
                        <div class="flex items-center gap-1.5 font-semibold text-text-main">
                            ...
                            <span>Wilayah POP: <strong class="text-text-main"><?php echo e($ticket->pop->name ?? '—'); ?></strong></span>
                        </div>
                        <span>•</span>
                        <div class="flex items-center gap-1.5 font-semibold text-text-main">
                            <svg class="h-4 w-4 text-violet-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <span>Dampak: <strong class="text-violet-600 dark:text-violet-400"><?php echo e($batchCount); ?> Pelanggan Terdaftar</strong></span>
                        </div>
                        <?php if($ticket->customer_odp): ?>
                            <span>•</span>
                            <div class="flex items-center gap-1.5 text-text-secondary font-mono">
                                <span>ODP: <strong class="text-text-main"><?php echo e($ticket->customer_odp); ?></strong></span>
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.countdown-timer','data' => ['deadline' => $ticket->slaDeadline()->toIso8601String(),'totalSeconds' => $ticket->slaTotalSeconds(),'label' => 'Sisa Waktu Handling SLA']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['deadline' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ticket->slaDeadline()->toIso8601String()),'total-seconds' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ticket->slaTotalSeconds()),'label' => 'Sisa Waktu Handling SLA']); ?>
...
<?php endif; ?>
                            <?php else: ?>
                                <span class="text-xs font-bold px-2.5 py-0.5 rounded-md border <?php echo e($ticket->slaBadgeClasses()); ?>">
                ...
                <div class="shrink-0 p-3.5 rounded-xl bg-surface/80 dark:bg-slate-900/60 border border-border backdrop-blur-xs space-y-1.5 text-xs">
                    <div class="flex items-center justify-between gap-3">
                        ...
                        <span class="font-bold text-text-main"><?php echo e($ticket->creator->name ?? '—'); ?></span>
                    </div>
                    <div class="flex items-center justify-between gap-3">
                        <span class="text-[10px] font-bold uppercase tracking-wider text-text-muted">Dibuat:</span>
                        <span class="font-mono text-text-main"><?php echo e(\App\Support\IndonesianDate::dateTime($ticket->created_at)); ?></span>
                    </div>
                    <?php if($ticket->resolved_at): ?>
                        <div class="flex items-center justify-between gap-3 pt-1 border-t border-border">
                            ...
                            <span class="font-mono text-emerald-600 dark:text-emerald-400 font-bold"><?php echo e(\App\Support\IndonesianDate::dateTime($ticket->resolved_at)); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-xs">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono font-black text-violet-700 dark:text-violet-300 text-sm"><?php echo e($ticket->fopTask->task_number); ?></span>
                            </div>
                            <p class="text-text-muted mt-0.5">
                                <?php if($ticket->fopTask->technicians->isNotEmpty()): ?>
                                    Teknisi: <span class="font-bold text-text-main"><?php echo e($ticket->fopTask->technicians->pluck('name')->join(', ')); ?></span>
                                <?php else: ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="p-4 rounded-xl border border-border bg-surface shadow-2xs space-y-1">
                ...
                <div class="text-2xl font-black font-mono text-violet-600 dark:text-violet-400">
                    <?php echo e($batchCount); ?> <span class="text-xs font-normal text-text-muted">User</span>
                </div>
            ...
            <div class="p-4 rounded-xl border border-border bg-surface shadow-2xs space-y-1">
                ...
                <div class="text-base font-bold text-text-main truncate">
                    <?php echo e($ticket->pop->name ?? '—'); ?>

                </div>
                <p class="text-[11px] text-text-muted truncate">
                    <?php echo e($ticket->customer_odp ? 'ODP: ' . $ticket->customer_odp : ($ticket->batchMembers->first()?->customer?->odp_code ? 'ODP: ' . $ticket->batchMembers->first()->customer->odp_code : 'Distribusi POP')); ?>
            ...
            <div class="p-4 rounded-xl border border-border bg-surface shadow-2xs space-y-1">
                ...
                <div class="text-base font-mono font-bold text-text-main">
                    <?php echo e($ticket->solvingTimeLabel() ?: $ticket->created_at->diffForHumans(null, true)); ?>

                </div>
                <p class="text-[11px] text-text-muted">
                    <?php echo e($ticket->resolved_at ? 'Waktu selesai/lepas' : 'Sedang berlangsung'); ?>
            ...
            <div class="p-4 rounded-xl border border-border bg-surface shadow-2xs space-y-1">
                ...
                <div class="text-base font-bold text-text-main">
                    <?php echo e($ticket->handler->label()); ?>

                </div>
                <p class="text-[11px] text-text-muted">
                    Status: <strong class="text-text-main"><?php echo e($ticket->statusLabel()); ?></strong>
                </p>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div class="min-w-0 space-y-2">
                    <div class="flex items-center gap-2.5 flex-wrap">
                        ...
                        <span class="text-xs font-mono font-bold px-2.5 py-0.5 rounded border <?php echo e($ticket->type->badgeClasses()); ?>">
                            <?php echo e($ticket->type->value); ?> — <?php echo e($ticket->type->label()); ?>
                    ...
                    <div class="flex items-center gap-2 text-xs text-text-muted">
                        <span class="font-bold text-text-main"><?php echo e($ticket->customer_name ?? '—'); ?></span>
                        <span>•</span>
...
<?php endif; ?>
                            <?php else: ?>
                                <span class="text-xs font-bold px-2.5 py-0.5 rounded border <?php echo e($ticket->slaBadgeClasses()); ?>">
                                    <?php echo e($ticket->slaBadgeLabel()); ?>
                ...
                <div class="pt-4 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-sky-50/50 dark:bg-slate-900/40 border border-sky-200 dark:border-sky-900/50 rounded-lg p-3.5">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-xs">
                            <div class="flex items-center gap-2">
                                <span class="font-bold text-text-main">Task FOP Lapangan Terkait:</span>
                                <span class="font-mono font-bold text-sky-600 dark:text-sky-400"><?php echo e($ticket->fopTask->task_number); ?></span>
                            </div>
                            <p class="text-text-muted mt-0.5">
                                <?php if($ticket->fopTask->technicians->isNotEmpty()): ?>
                                    Teknisi: <span class="font-medium text-text-main"><?php echo e($ticket->fopTask->technicians->pluck('name')->join(', ')); ?></span>
                                <?php else: ?>
    ...
    <?php if($ticketActions['can_close'] || $ticketActions['can_escalate_noc'] || $ticketActions['can_escalate_fop'] || $ticketActions['can_return_to_helpdesk'] || $ticketActions['can_cancel']): ?>
    <div class="bg-surface border border-amber-200 dark:border-amber-900/50 rounded-xl p-5 shadow-xs">
        <div class="flex items-center justify-between gap-2 mb-3">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-xs font-bold uppercase tracking-wider text-text-main">Aksi Tiket — Ditangani <?php echo e($ticket->handler->label()); ?></h2>
            </div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.close', $ticket)); ?>', null, 'Selesaikan Tiket', 'Apa yang sudah dikerjakan? (opsional)', false, 'Tandai tiket ini selesai?')"
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.escalate', $ticket)); ?>', 'noc', 'Kirim Tiket ke NOC', 'Catatan buat NOC (opsional)', false, 'Kirim tiket ini ke NOC?')"
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.escalate', $ticket)); ?>', 'fop', 'Kirim Tiket ke FOP', 'Catatan buat FOP (opsional)', false, 'Kirim tiket ini ke FOP? Task FOP baru akan dibuat.')"
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.return-to-helpdesk', $ticket)); ?>', null, 'Kembalikan ke Helpdesk', 'Alasan dikembalikan (opsional)', false, 'Kembalikan tiket ini ke Helpdesk?')"
            ...
            <button type="button"
                onclick="confirmTicketDetailAction('<?php echo e(route('tickets.cancel', $ticket)); ?>', null, 'Batalkan Tiket', 'Alasan pembatalan (wajib diisi)', true, 'Batalkan tiket ini? Tindakan ini tidak bisa dibatalkan kembali.')"
    ...
    <?php if($isBatch): ?>
        <div x-data="batchRosterManager({
            ...
            storeUrl: '<?php echo e(route('tickets.batch-members.store', $ticket)); ?>',
            lookupUrl: '<?php echo e(route('tickets.lookup-customer')); ?>',
            members: <?php echo e(Js::from($ticket->batchMembers->map(fn($m) => [
                'id' => $m->id,
                ...
                <div class="border border-border rounded-lg overflow-hidden bg-border shadow-xs">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
                        ...
                        <div class="bg-surface p-3 space-y-1">
                            ...
                            <div class="text-xs font-semibold text-text-main truncate"><?php echo e($ticket->customer_name ?: '—'); ?></div>
                        </div>
                        ...
                        <div class="bg-surface p-3 space-y-1">
                            ...
                            <div class="text-xs font-bold font-mono text-sky-600 dark:text-sky-400 truncate">
                                <?php echo e($customer?->display_id ?: ($customer?->cid ?: ($customer?->customer_code ?: '—'))); ?>
                        ...
                        <div class="bg-surface p-3 space-y-1">
                            ...
                            <div class="text-xs font-mono text-text-main truncate">
                                <?php if($ticket->customer_phone): ?>
                                    <a href="https://wa.me/<?php echo e($ticket->customer_phone); ?>" target="_blank" rel="noopener" class="text-emerald-600 dark:text-emerald-400 hover:underline">
                                        <?php echo e($ticket->customer_phone); ?>
                        ...
                        <div class="bg-surface p-3 space-y-1">
                            ...
                            <div class="text-xs font-medium text-text-main truncate"><?php echo e($ticket->customer_package ?: '—'); ?></div>
                        </div>
                        ...
                        <div class="bg-surface p-3 space-y-1 md:col-span-2">
                            ...
                            <div class="text-xs text-text-main line-clamp-2"><?php echo e($ticket->customer_address ?: '—'); ?></div>
                        </div>

                        
                        <div class="bg-surface p-3 space-y-1">
                            <span class="block text-[10px] font-bold text-text-muted uppercase tracking-wider">POP / Cabang</span>
                            <div class="text-xs font-semibold text-text-main"><?php echo e($ticket->pop->name ?? '—'); ?></div>
                        </div>

                        
                        <div class="bg-surface p-3 space-y-1">
                            <span class="block text-[10px] font-bold text-text-muted uppercase tracking-wider">ODP Port</span>
                            <div class="text-xs font-mono font-medium text-text-main"><?php echo e($ticket->customer_odp ?: '—'); ?></div>
                        </div>

                        
                        <div class="bg-surface p-3 space-y-1 md:col-span-2">
                            <span class="block text-[10px] font-bold text-text-muted uppercase tracking-wider">Perangkat Pelanggan (ONT/Router)</span>
                            <div class="text-xs font-mono text-text-main"><?php echo e($ticket->customer_device ?: '—'); ?></div>
                        </div>
                        ...
                        <div class="bg-surface p-3 space-y-1 md:col-span-2">
                            ...
                            <div class="text-xs font-mono text-sky-600 dark:text-sky-400 flex items-center gap-1">
                                ...
                                <?php if($koordinat): ?>
                                    <a href="<?php echo e($ticket->customerMapsUrl()); ?>" target="_blank" rel="noopener"
                                       class="hover:underline font-bold"><?php echo e($koordinat); ?></a>
                                <?php else: ?>
                                    <span>—</span>
                                <?php endif; ?>
                            </div>
    ...
    <div class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs space-y-4">
        <div class="px-6 py-3.5 border-b border-border bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <span class="w-1.5 h-4 <?php echo e($isBatch ? 'bg-violet-600' : 'bg-sky-600'); ?> rounded-full"></span>
                <h2 class="text-xs font-bold uppercase tracking-wider text-text-main"><?php echo e($isBatch ? 'ISSUE & NOC MASS INCIDENT ASSESSMENT' : 'ISSUE & NOC TECHNICAL ASSESSMENT'); ?></h2>
            </div>
        ...
        <div class="p-6 space-y-5">
            ...
            <div class="space-y-1.5">
                <span class="block text-[11px] font-bold text-text-muted uppercase tracking-wider"><?php echo e($isBatch ? 'Detail Dampak Gangguan (Mass Outage Description)' : 'Detail Keluhan (Customer Complaint)'); ?></span>
            ...
            <div class="space-y-1.5">
                ...
                <div class="p-4 bg-slate-900/5 dark:bg-slate-900/40 border border-border rounded-xl text-xs font-mono text-text-main italic leading-relaxed whitespace-pre-line">
                    <?php echo e($ticket->catatan_teknis ?: 'Tidak ada catatan teknis awal.'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs">
            <div class="px-6 py-3.5 border-b border-border bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between">
                ...
                <span class="text-[10px] font-mono text-text-muted"><?php echo e($ticket->histories->count()); ?> log</span>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $ticket->histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                        <div class="flex items-center justify-between gap-2">
                            <span class="text-[10px] font-bold font-mono px-2 py-0.5 rounded border <?php echo e($history->action->badgeClasses()); ?>">
                                <?php echo e($history->action->label()); ?>
                        ...
                        <p class="text-xs font-semibold text-text-secondary mt-2">
                            oleh <span class="text-text-main font-bold"><?php echo e($history->actor->name ?? 'Sistem'); ?></span>
                        </p>
        ...
        <div class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs">
            <div class="px-6 py-3.5 border-b border-border bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between">
                ...
                <span class="text-[10px] font-mono text-text-muted"><?php echo e(count(optional($ticket->fopTask)->statusHistories ?? [])); ?> log</span>
            </div>

            <ul class="divide-y divide-border">
                <?php $__empty_1 = true; $__currentLoopData = optional($ticket->fopTask)->statusHistories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                        <div class="flex items-center justify-between gap-2">
                            <span class="text-[10px] font-bold font-mono px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-border text-text-main">
                                <?php echo e($history->label()); ?>

                            </span>
                            <span class="text-[10px] font-mono text-text-muted">
                                <?php echo e(\App\Support\IndonesianDate::dateTime($history->changed_at)); ?>

                            </span>
                        </div>

                        <p class="text-xs font-semibold text-text-secondary mt-2">
                            oleh <span class="text-text-main font-bold"><?php echo e($history->changedByUser->name ?? 'Sistem'); ?></span>
                        </p>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <li class="p-6 text-center text-xs text-text-muted font-mono">
                        <?php echo e($ticket->fopTask ? 'Belum ada perubahan status FOP.' : 'Task FOP tidak aktif.'); ?>
    ...
    <div class="bg-surface border border-border rounded-xl overflow-hidden shadow-xs">
        <div class="px-6 py-3.5 border-b border-border bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <span class="w-1.5 h-4 bg-sky-600 rounded-full"></span>
                <h2 class="text-xs font-bold uppercase tracking-wider text-text-main">EVIDENCE &amp; ATTACHMENTS (<?php echo e($ticket->attachments->count()); ?>)</h2>
            </div>
        </div>
            ...
            <?php $__currentLoopData = $ticket->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center justify-between p-4 hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-text-main truncate"><?php echo e($attachment->original_name); ?></p>
                            <p class="text-[10px] font-mono text-text-muted mt-0.5">
                                <?php echo e($attachment->humanSize()); ?> • <?php echo e($attachment->uploader->name ?? 'System'); ?>
            ...
            async submitBatchMember() {
                ...
                try {
                    ...
                    const newMember = {
                        ...
                        added_by: '<?php echo e(auth()->user()->name); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/yopi/whusnet/whusnet-operasional/resources/views/tickets/show.blade.php ENDPATH**/ ?>