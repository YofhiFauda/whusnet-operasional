                ...
                <div id="step-panel-1" class="step-panel space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-xs font-semibold text-text-secondary">
                        ...
                        <div>
                            ...
                            <input type="text" name="identity_number" id="identity_number" value="<?php echo e(old('identity_number', $customer->identity_number)); ?>" class="w-full text-sm font-sans px-3 py-2 border border-border rounded-md bg-surface text-text-main focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/25" placeholder="Contoh: 3502182039200001">
                        </div>
